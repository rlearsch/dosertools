...
def test_convert_tiff_image_saves_intermediate_files():
    ...
    if os.path.exists(os.path.join("image_processing","test_processed_images","crop","401.tiff")):
        os.remove(os.path.join("image_processing","test_processed_images","crop","401.tiff"))
    if os.path.exists(os.path.join("image_processing","test_processed_images","bg_sub","401.tiff")):
        os.remove(os.path.join("image_processing","test_processed_images","bg_sub","401.tiff"))
    if os.path.exists(os.path.join("image_processing","test_processed_images","bin","401.png")):
        os.remove(os.path.join("image_processing","test_processed_images","bin","401.png"))
     
    bg_median = np.load("image_processing//bg_median_array.npy")
    with open(os.path.join("image_processing","params.json")) as f:
        params_dict = json.load(f)
        
    image_location = os.path.join("image_processing","example_experimental_video","2021-09-16_RWL-I-158-1_2.6MDa-TPAM-1.0wtpct-0.0x-NiCl_22G_shutter-50k_fps-25k_DOS-Al_4_exp_2109_1723000401.tif")
    ...
    assert os.path.exists(os.path.join("image_processing","test_processed_images","crop","401.tiff"))
    assert os.path.exists(os.path.join("image_processing","test_processed_images","bg_sub","401.tiff"))
    assert os.path.exists(os.path.join("image_processing","test_processed_images","bin","401.png"))
...
def test_convert_tiff_image_converts_intermediate_files():
    ...
    produced_bin = skimage.io.imread(os.path.join("image_processing","test_processed_images","bin","401.png"))
    produced_crop = skimage.io.imread(os.path.join("image_processing","test_processed_images","crop","401.tiff"))
    produced_bg_sub = skimage.io.imread(os.path.join("image_processing","test_processed_images","bg_sub","401.tiff"))
...
def test_convert_tiff_sequence_to_binary():
    ...
    for i in range(0,len(target_converted_sequence)):
        if os.path.exists(os.path.join("image_processing","tmp_path","bin",f"{i:03}.png")):
            os.remove((os.path.join("image_processing","tmp_path","bin",f"{i:03}.png")))
