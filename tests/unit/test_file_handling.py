...
class TestFoldernameParse:
    ...
    def test_returns_dict(self):
        ...
        assert type(fh.foldername_parse(self.folder,self.fname_format,self.sampleinfo_format,self.fname_split,self.sample_split)) is dict
    ...
    def test_correct_parse_fps_k(self):
        ...
        assert fh.foldername_parse(self.folder,self.fname_format,self.sampleinfo_format,self.fname_split,self.sample_split) == self.file_dict
